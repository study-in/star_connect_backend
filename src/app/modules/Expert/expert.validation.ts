// src/app/modules/Expert/expert.validation.ts
import { z } from 'zod';

// Example: Basic validation for creation
const createExpertValidationSchema = z.object({
  body: z.object({
    name: z.string({ required_error: 'Expert name is required' }).min(1),
...
const updateExpertValidationSchema = createExpertValidationSchema.deepPartial();
