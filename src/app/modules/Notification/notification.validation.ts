...
const createNotificationValidationSchema = z.object({
  body: z.object({
    name: z.string({ required_error: 'Notification name is required' }).min(1),
...
const updateNotificationValidationSchema = createNotificationValidationSchema.deepPartial();
